    ...
    return {
        ...
        accounts: {
            ...
            [newUUID()]: {
                ...
                eventIds: [],
                display: defaultAccountDisplay({ color: 'hsl(31, 81%, 48%)', dash: 'solid' })
            },
            [newUUID()]: {
                args: { 
                    openDate: today, 
                ...
                accountType: 'Checking Account',
                eventIds: [],
                display: defaultAccountDisplay({ color: 'hsl(242, 86%, 62%)', dash: 'dashdot' })
            },
        ...
        // Events
        //=================================================================================
        events: {} as Record<UUID, EventJSON>,
