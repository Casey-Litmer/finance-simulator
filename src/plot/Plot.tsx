...
import Profile, { clearProfile, showProfile } from "../simulation/benchmarking/Profiler";
...
const SimPlot = () => {
    ...
    const formatData = (simData?: SimulationData) => {
        ...
        .filter(([key, accData]) => //Filter out all non-visible accounts
