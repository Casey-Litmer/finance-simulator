...
import { Add, CheckBoxOutlineBlank, CheckBoxOutlined, ChevronLeft, ChevronRight, Edit, KeyboardDoubleArrowRight} from '@mui/icons-material';
...
export default function AccountItem(props: AccountItemProps) {
    ...
    const handleColorCallback = (line: Partial<ScatterLine>) => {simulation.dispatchSaveState({accountsDisplay:{[accountId]:{line}}})};
