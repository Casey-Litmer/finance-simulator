...
import { AccountJSON } from '../../simulation/types';
import { AccountConstructorMap } from '../../simulation/ConstructorMaps';
import { DateSelector, DropdownSelect, InputField } from '../../components/dataentry/DataEntry';
import { CheckBoxOutlineBlank, CheckBoxOutlined, Save } from '@mui/icons-material';
...
export default function NewAccountMenu(props: NewAccountMenuProps) {
